...
from crudlogin.sql import *

# blueprint defaults https://flask.palletsprojects.com/en/2.0.x/api/#blueprint-objects
from crudlogin.model import Users
from crudlogin.sql import users_all, user_by_email, user_by_id, users_ilike
...
def api_tester():
    ...
    url = 'http://localhost:6969/crud_api'
